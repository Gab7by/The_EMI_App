        ...
        >
            ...
            <View 
                ...
                <View className="flex-1 gap-7">
                    ...
                    >
                        <SelectTrigger ref={ref} className="w-full bg-menorah-primary border-0 rounded-xl px-4 py-2">
                        <SelectValue
                            className="text-menorah-darkGreen font-medium"
                            ...
                            {PLAYLIST_OPTIONS.map((option, index) => (
                                <View key={option.value}>
                                    <SelectItem
                                        label={option.label}
                                        value={option.value}
                                        className="text-menorah-darkGreen font-medium p-2"
                                    >
                                        {option.label}
                                    </SelectItem>
